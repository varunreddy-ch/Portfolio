    ...
    return <section id="projects" className={styles.container}>
        ...
        <div className={styles.projectsContainer}>
            ...
            <div className={styles.projectsContainer1}>
                ...
                desc="The Jigsaw Puzzle Solver leverages AI and computer vision to analyze puzzle piece shapes and features, identifying matching edges to automate assembly, demonstrating AI's potential in solving complex visual challenges."
                />
            </div>
            {/* Project 5 */}
            <div className={styles.projectsContainer1}>
